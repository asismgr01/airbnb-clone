                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     @if(isset($hotel_info) && !empty($hotel_info))
                        {{Form::open(['url'=>route('adminhotel.update',$hotel_info->id),'class'=>'form','enctype'=>'multipart/form-data'])}}
                        @method('PUT')
                      @else
                        {{Form::open(['url'=>route('adminhotel.store'),'class'=>'form','enctype'=>'multipart/form-data'])}}
                      @endif
