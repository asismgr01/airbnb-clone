                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     @if(isset($room_info) && !empty($room_info))
                        {{Form::open(['url'=>route('adminroom.update',$room_info->id),'class'=>'form','enctype'=>'multipart/form-data'])}}
                        @method('PUT')
                      @else
                        {{Form::open(['url'=>route('adminroom.store'),'class'=>'form','enctype'=>'multipart/form-data'])}}
                      @endif
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          {{ Form::text('hotel_id',@$room_info->hotel_name,['class'=>'form-control','id'=>'hotel_id','autocomplete'=>'off','disable'=>'disabled'])}}
