			...
			<div class="header-cart-content flex-w js-pscroll">
				...
				<ul class="header-cart-wrapitem w-full">
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						...
						<!--Yedi remove cart ma trash button click garda particular
							product sabai remove garne ho vane chai, removecart() ma 
						    $cart_items['quantity'] pass garne.-->
						<a href="javascript:0;" onclick="removeFromcart({{ $key }},{{ 1 }});" >
