                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     @if(isset($activities_info) && !empty($activities_info))
                        {{Form::open(['url'=>route('activities.update',$activities_info->id),'class'=>'form','enctype'=>'multipart/form-data'])}}
                        @method('PUT')
                      @else
                        {{Form::open(['url'=>route('activities.store'),'class'=>'form','enctype'=>'multipart/form-data'])}}
                      @endif
                      ...
                      <div class="form-group row">
                      	...
                      	<div class="col-sm-9">
                      		{{ Form::select('city',$city,@ucfirst($activities_info->city),['class'=>'form-control','id'=>'city','required'=>true])}}
                      		@if($errors->has('city'))
